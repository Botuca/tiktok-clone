  ...
  return (
    <>
      <div
        id="SideNavMain"
        className={`
          fixed z-20 bg-white pt-[70px] h-full lg:border-r-0 border-r w-[75px] overflow-auto items-cente
        ...
        <div className="lg:w-full w-[55px] mx-auto">
          ...
          <div className="lg:block hidden text-[11px] text-gray-500">
            <p className="pt-4 px-2">
              About Newsroom TikTok Shop Contact Carrers ByteDance
            </p>
            <p className="pt-4 px-2">
            ...
            <p className="pt-4 px-2">
              Help Safety Term Privacy Creator Portal Commnunity Guidelines
            </p>
